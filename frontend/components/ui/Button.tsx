...
const variantClasses: Record<Variant, string> = {
  ...
  secondary: "bg-white text-ink border border-slate-200 hover:bg-slate-50 dark:bg-slate-800/90 dark:text-white dark:border-slate-700 dark:hover:bg-slate-800",
